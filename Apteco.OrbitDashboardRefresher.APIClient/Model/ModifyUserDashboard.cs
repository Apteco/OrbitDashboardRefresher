...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifyUserDashboard :  IEquatable<ModifyUserDashboard>, IValidatableObject
    {
        /// <summary>
        ...
        protected ModifyUserDashboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyUserDashboard" /> class.
        /// </summary>
        /// <param name="dashboard">The audience to modify (required).</param>
        ...
        public ModifyUserDashboard(ModifyUserDashboardDetail dashboard = default(ModifyUserDashboardDetail), int? id = default(int?), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyUserDashboard and cannot be null");
            }
            else
            {
                this.Id = id;
