...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    public partial class Export :  IEquatable<Export>
    {
        ...
        /// <param name="filterQuery">If the resolve table is set to a descendant table of the base query&#39;s then this query can be used to filter that descendant table records.</param>
        ...
        /// <param name="output">If this export is exporting to a file, information about the how the export will be output.</param>
        ...
        /// <summary>
        /// If the resolve table is set to a descendant table of the base query&#39;s then this query can be used to filter that descendant table records
        /// </summary>
        /// <value>If the resolve table is set to a descendant table of the base query&#39;s then this query can be used to filter that descendant table records</value>
        ...
        /// <summary>
        /// If this export is exporting to a file, information about the how the export will be output
        /// </summary>
        /// <value>If this export is exporting to a file, information about the how the export will be output</value>
