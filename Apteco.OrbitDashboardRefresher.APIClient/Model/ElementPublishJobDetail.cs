...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ElementPublishJobDetail :  IEquatable<ElementPublishJobDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementPublishJobDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ElementPublishJobDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementPublishJobDetail" /> class.
        /// </summary>
        ...
        public ElementPublishJobDetail(int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
