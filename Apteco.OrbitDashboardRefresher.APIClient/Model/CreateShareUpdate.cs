...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateShareUpdate :  IEquatable<CreateShareUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="notifyRemovedRecipients">Whether to notify existing recipients that the share has been updated (required).</param>
        ...
        /// <param name="notifyUnchangedRecipients">Whether to notify recipients that the shareable item is shared with, but that haven&#39;t   been added or removed that the share has been updated (required).</param>
        ...
        public CreateShareUpdate(string notes = default(string), List<string> emailAddressesToAdd = default(List<string>), List<int?> userIdsToAdd = default(List<int?>), List<int?> groupIdsToAdd = default(List<int?>), bool? shareToAll = default(bool?), bool? notifyAddedRecipients = default(bool?), string addedRecipientNotificationMessage = default(string), List<string> emailAddressesToRemove = default(List<string>), List<int?> userIdsToRemove = default(List<int?>), List<int?> groupIdsToRemove = default(List<int?>), bool? notifyRemovedRecipients = default(bool?), string removedRecipientNotificationMessage = default(string), bool? notifyUnchangedRecipients = default(bool?), string unchangedRecipientNotificationMessage = default(string))
        {
        ...
        /// <summary>
        /// Whether to notify existing recipients that the share has been updated
        /// </summary>
        /// <value>Whether to notify existing recipients that the share has been updated</value>
        ...
        /// <summary>
        /// Whether to notify recipients that the shareable item is shared with, but that haven&#39;t   been added or removed that the share has been updated
        /// </summary>
        /// <value>Whether to notify recipients that the shareable item is shared with, but that haven&#39;t   been added or removed that the share has been updated</value>
