...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifyUserAudienceDetail :  IEquatable<ModifyUserAudienceDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public ModifyUserAudienceDetail(StatusEnum? status = default(StatusEnum?), string title = default(string), string description = default(string), string briefText = default(string), Query excludeQuery = default(Query), Query includeQuery = default(Query), Query bodyQuery = default(Query), SelectionModifiers selectionModifiers = default(SelectionModifiers))
        {
            this.Status = status;
            this.Title = title;
