...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifyChannelsJobDetail :  IEquatable<ModifyChannelsJobDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyChannelsJobDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifyChannelsJobDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyChannelsJobDetail" /> class.
        /// </summary>
        ...
        public ModifyChannelsJobDetail(int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
