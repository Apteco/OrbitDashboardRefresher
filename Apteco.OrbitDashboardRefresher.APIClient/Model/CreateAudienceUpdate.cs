...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateAudienceUpdate :  IEquatable<CreateAudienceUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateAudienceUpdate(string title = default(string), string description = default(string), bool? isDeleted = default(bool?), Query excludeQuery = default(Query), Query includeQuery = default(Query), Query bodyQuery = default(Query), SelectionModifiers selectionModifiers = default(SelectionModifiers), string briefText = default(string), string campaignId = default(string))
        {
            this.Title = title;
