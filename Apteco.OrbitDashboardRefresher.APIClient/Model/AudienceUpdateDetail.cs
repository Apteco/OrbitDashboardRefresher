...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AudienceUpdateDetail :  IEquatable<AudienceUpdateDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceUpdateDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AudienceUpdateDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceUpdateDetail" /> class.
        /// </summary>
        /// <param name="briefText">Notes associated with the audience at the time of this update.</param>
        /// <param name="excludeQuery">The query rule that defines the records to exclude from this audience at the time of this update.</param>
        /// <param name="includeQuery">The query rule that defines the records to start with when defining this audience at the time of this update.</param>
        /// <param name="bodyQuery">The query rule that defines the records that will make up this audience at the time of this update..</param>
        ...
        /// <param name="owner">The details of the user that owned this audience at the time of this update (required).</param>
        ...
        public AudienceUpdateDetail(string briefText = default(string), Query excludeQuery = default(Query), Query includeQuery = default(Query), Query bodyQuery = default(Query), SelectionModifiers selectionModifiers = default(SelectionModifiers), int? id = default(int?), DateTime? timestamp = default(DateTime?), UserDisplayDetails user = default(UserDisplayDetails), string title = default(string), string description = default(string), UserDisplayDetails owner = default(UserDisplayDetails), bool? isDeleted = default(bool?), string resolveTableName = default(string), string campaignId = default(string))
        {
        ...
        /// <summary>
        /// The query rule that defines the records to exclude from this audience at the time of this update
        /// </summary>
        /// <value>The query rule that defines the records to exclude from this audience at the time of this update</value>
        [DataMember(Name="excludeQuery", EmitDefaultValue=false)]
        public Query ExcludeQuery { get; set; }

        /// <summary>
        /// The query rule that defines the records to start with when defining this audience at the time of this update
        /// </summary>
        /// <value>The query rule that defines the records to start with when defining this audience at the time of this update</value>
        [DataMember(Name="includeQuery", EmitDefaultValue=false)]
        public Query IncludeQuery { get; set; }

        /// <summary>
        /// The query rule that defines the records that will make up this audience at the time of this update.
        /// </summary>
        /// <value>The query rule that defines the records that will make up this audience at the time of this update.</value>
        ...
        /// <summary>
        /// The details of the user that owned this audience at the time of this update
        /// </summary>
        /// <value>The details of the user that owned this audience at the time of this update</value>
