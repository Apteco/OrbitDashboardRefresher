...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateDashboardUpdateDetail :  IEquatable<CreateDashboardUpdateDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDashboardUpdateDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateDashboardUpdateDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDashboardUpdateDetail" /> class.
        /// </summary>
        ...
        public CreateDashboardUpdateDetail(int? id = default(int?), string title = default(string), string description = default(string), int? themeId = default(int?), int? logoId = default(int?), Query baseQuery = default(Query), List<DashboardContentItem> dashboardItems = default(List<DashboardContentItem>), string systemName = default(string))
        {
        ...
        /// <summary>
        /// The base query for the dashboard
        /// </summary>
