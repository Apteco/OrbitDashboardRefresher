...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AudienceExportDetail :  IEquatable<AudienceExportDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceExportDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AudienceExportDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceExportDetail" /> class.
        /// </summary>
        ...
        /// <param name="output">If this audience is exporting to a file, information about the how the export will be output.</param>
        ...
        public AudienceExportDetail(int? audienceUpdateId = default(int?), DateTime? timestamp = default(DateTime?), DateTime? fastStatsBuildDate = default(DateTime?), UserDisplayDetails user = default(UserDisplayDetails), List<Count> nettCounts = default(List<Count>), string urnFilePath = default(string), long? maximumNumberOfRowsToBrowse = default(long?), bool? returnBrowseRows = default(bool?), string filePath = default(string), Output output = default(Output), List<Column> columns = default(List<Column>), List<Row> rows = default(List<Row>))
        {
        ...
        /// <summary>
        /// If this audience is exporting to a file, information about the how the export will be output
        /// </summary>
        /// <value>If this audience is exporting to a file, information about the how the export will be output</value>
