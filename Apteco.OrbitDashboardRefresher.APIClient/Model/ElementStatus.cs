...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    public partial class ElementStatus :  IEquatable<ElementStatus>, IValidatableObject
    {
        ...
        public ElementStatus(string id = default(string), string description = default(string), TypeEnum type = default(TypeEnum), int? successfulCampaignsCount = default(int?), int? erroredCampaignsCount = default(int?), int? inactiveCampaignsCount = default(int?), int? needsApprovalCampaignsCount = default(int?), List<ChannelTypesEnum> channelTypes = default(List<ChannelTypesEnum>), DateTime? firstRan = default(DateTime?), DateTime? lastRan = default(DateTime?), DateTime? lastAction = default(DateTime?), DateTime? statisticsTimestamp = default(DateTime?), List<ElementKey> path = default(List<ElementKey>))
        {
