...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SaveQueryFile :  IEquatable<SaveQueryFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveQueryFile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SaveQueryFile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveQueryFile" /> class.
        /// </summary>
        /// <param name="path">The path of the query to save (required).</param>
        /// <param name="query">The query definition (required).</param>
