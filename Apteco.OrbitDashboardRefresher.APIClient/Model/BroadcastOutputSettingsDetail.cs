...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BroadcastOutputSettingsDetail :  IEquatable<BroadcastOutputSettingsDetail>, IValidatableObject
    {
        /// <summary>
        ...
        protected BroadcastOutputSettingsDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BroadcastOutputSettingsDetail" /> class.
        /// </summary>
        ...
        public BroadcastOutputSettingsDetail(string username = default(string), List<Parameter> parameters = default(List<Parameter>), string replyEmailAddress = default(string), ResponseFileKeyTypeEnum? responseFileKeyType = default(ResponseFileKeyTypeEnum?), int? retries = default(int?), bool? supportsListNameSelection = default(bool?), bool? addAdditionalVariablesDirectly = default(bool?), DirectAdditionalVariablesLocationEnum? directAdditionalVariablesLocation = default(DirectAdditionalVariablesLocationEnum?), int? initialResponseImpact = default(int?), BroadcasterTypeEnum broadcasterType = default(BroadcasterTypeEnum), bool? appendToList = default(bool?), MessageContentTypeEnum messageContentType = default(MessageContentTypeEnum), bool? uploadButDontBroadcast = default(bool?), VariableDetails emailVariableDetails = default(VariableDetails), VariableDetails smsVariableDetails = default(VariableDetails), List<VariableDetails> additionalVariables = default(List<VariableDetails>), FileSettings fileSettings = default(FileSettings), AllowTransactionalOutputEnum allowTransactionalOutput = default(AllowTransactionalOutputEnum))
        {
