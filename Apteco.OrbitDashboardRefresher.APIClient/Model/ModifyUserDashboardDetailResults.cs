...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifyUserDashboardDetailResults :  IEquatable<ModifyUserDashboardDetailResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyUserDashboardDetailResults" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifyUserDashboardDetailResults() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyUserDashboardDetailResults" /> class.
        /// </summary>
        /// <param name="dashboard">The details of the modified audience.</param>
        ...
        public ModifyUserDashboardDetailResults(UserDashboardDetail dashboard = default(UserDashboardDetail), int? id = default(int?), bool? succeeded = default(bool?), string status = default(string), int? statusCode = default(int?))
        {
