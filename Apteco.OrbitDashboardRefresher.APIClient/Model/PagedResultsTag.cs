...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedResultsTag :  IEquatable<PagedResultsTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResultsTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsTag" /> class.
        /// </summary>
        ...
        public PagedResultsTag(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<Tag> list = default(List<Tag>))
        {
            ...
            if (list == null)
            {
                throw new InvalidDataException("list is a required property for PagedResultsTag and cannot be null");
            }
            else
            {
                this.List = list;
