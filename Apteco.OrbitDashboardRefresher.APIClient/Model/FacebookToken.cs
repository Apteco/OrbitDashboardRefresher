...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    public partial class FacebookToken :  IEquatable<FacebookToken>
    {
        ...
        public FacebookToken(int? id = default(int?), FacebookEntityTypeEnum facebookEntityType = default(FacebookEntityTypeEnum), string systemName = default(string), string token = default(string))
        {
            ...
            if (systemName == null)
            {
                throw new InvalidDataException("systemName is a required property for FacebookToken and cannot be null");
            }
            else
            {
