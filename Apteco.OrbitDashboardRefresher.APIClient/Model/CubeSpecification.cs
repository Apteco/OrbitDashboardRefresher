...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CubeSpecification :  IEquatable<CubeSpecification>, IValidatableObject
    {
        /// <summary>
        ...
        public CubeSpecification(List<Dimension> dimensions = default(List<Dimension>), List<Measure> measures = default(List<Measure>), SubTotalsEnum? subTotals = default(SubTotalsEnum?))
        {
