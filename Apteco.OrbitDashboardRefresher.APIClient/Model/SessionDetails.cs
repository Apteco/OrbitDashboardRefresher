...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    public partial class SessionDetails :  IEquatable<SessionDetails>, IValidatableObject
    {
        ...
        public SessionDetails(string accessToken = default(string), UserDisplayDetails user = default(UserDisplayDetails), string sessionId = default(string), DateTime? lastLogin = default(DateTime?), Licence licence = default(Licence))
        {
