...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkedInEntity :  IEquatable<LinkedInEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public LinkedInEntity(int? id = default(int?), LinkedInEntityTypeEnum linkedInEntityType = default(LinkedInEntityTypeEnum), string name = default(string), string systemName = default(string), List<string> permissions = default(List<string>), bool? valid = default(bool?), int? appId = default(int?))
        {
            ...
            if (systemName == null)
            {
                throw new InvalidDataException("systemName is a required property for LinkedInEntity and cannot be null");
            }
            else
            {
