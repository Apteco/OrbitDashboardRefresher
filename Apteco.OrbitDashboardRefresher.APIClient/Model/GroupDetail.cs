...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupDetail :  IEquatable<GroupDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public GroupDetail(int? id = default(int?), string name = default(string), List<UserSummary> userMembership = default(List<UserSummary>), int? userMembershipCount = default(int?), bool? systemMembership = default(bool?))
        {
