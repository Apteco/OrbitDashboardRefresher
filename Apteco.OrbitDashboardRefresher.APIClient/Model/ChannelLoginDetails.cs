...
namespace Apteco.OrbitDashboardRefresher.APIClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChannelLoginDetails :  IEquatable<ChannelLoginDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public ChannelLoginDetails(BroadcasterTypeEnum? broadcasterType = default(BroadcasterTypeEnum?), MessageContentTypeEnum? messageContentType = default(MessageContentTypeEnum?), string username = default(string), string password = default(string), List<Parameter> parameters = default(List<Parameter>))
        {
