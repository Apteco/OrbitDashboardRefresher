...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface ISharesApi : IApiAccessor
    {
        ...
        /// <param name="shareDetail">The details of the shareable item (collection, audience, etc) to share and who to share it with (optional)</param>
        ...
        /// <returns>PagedResultsGroupDetail</returns>
        PagedResultsGroupDetail SharesGetShareGroups (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null);
        ...
        /// <param name="offset">The number of items to skip in the (potentially filtered) result set before returning subsequent items. (optional)</param>
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>ApiResponse of PagedResultsGroupDetail</returns>
        ApiResponse<PagedResultsGroupDetail> SharesGetShareGroupsWithHttpInfo (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null);
        /// <summary>
        ...
        /// <param name="offset">The number of items to skip in the (potentially filtered) result set before returning subsequent items. (optional)</param>
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>Task of PagedResultsGroupDetail</returns>
        System.Threading.Tasks.Task<PagedResultsGroupDetail> SharesGetShareGroupsAsync (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null);
        ...
        /// <param name="offset">The number of items to skip in the (potentially filtered) result set before returning subsequent items. (optional)</param>
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResultsGroupDetail)</returns>
        System.Threading.Tasks.Task<ApiResponse<PagedResultsGroupDetail>> SharesGetShareGroupsAsyncWithHttpInfo (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null);
        /// <summary>
        /// Returns a specific update that is associated with a particular share
        /// </summary>
        /// <remarks>
    ...
    public partial class SharesApi : ISharesApi
    {
        ...
        /// <returns></returns>
        public SharesApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< ShareDetail > SharesCreateShareWithHttpInfo (string dataViewName, CreateShareDetail shareDetail = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(shareDetail); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse< CreatedShareUpdateDetail > SharesCreateShareUpdateWithHttpInfo (string dataViewName, int? shareId, CreateShareUpdate shareUpdate = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(shareUpdate); // http body (model) parameter
            }
            else
            {
        ...
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>PagedResultsGroupDetail</returns>
        public PagedResultsGroupDetail SharesGetShareGroups (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null)
        {
             ApiResponse<PagedResultsGroupDetail> localVarResponse = SharesGetShareGroupsWithHttpInfo(dataViewName, shareId, filter, orderBy, offset, count);
             return localVarResponse.Data;
        }
        ...
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>ApiResponse of PagedResultsGroupDetail</returns>
        public ApiResponse< PagedResultsGroupDetail > SharesGetShareGroupsWithHttpInfo (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>Task of PagedResultsGroupDetail</returns>
        public async System.Threading.Tasks.Task<PagedResultsGroupDetail> SharesGetShareGroupsAsync (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null)
        {
             ApiResponse<PagedResultsGroupDetail> localVarResponse = await SharesGetShareGroupsAsyncWithHttpInfo(dataViewName, shareId, filter, orderBy, offset, count);
             return localVarResponse.Data;
        ...
        /// <param name="count">The maximum number of items to show from the (potentially filtered) result set. (optional)</param>
        /// <returns>Task of ApiResponse (PagedResultsGroupDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PagedResultsGroupDetail>> SharesGetShareGroupsAsyncWithHttpInfo (string dataViewName, int? shareId, string filter = null, string orderBy = null, int? offset = null, int? count = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling SharesApi->SharesGetShareGroups");
