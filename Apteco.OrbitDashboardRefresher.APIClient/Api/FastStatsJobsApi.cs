...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public partial class FastStatsJobsApi : IFastStatsJobsApi
    {
        ...
        /// <returns></returns>
        public FastStatsJobsApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< ProcessingTimeStatistics > FastStatsJobsCalculateProcessingTimeStatsForSystemSyncWithHttpInfo (string dataViewName, string systemName, ProcessingTimeStatisticsDetails processingTimeStatisticsDetails = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(processingTimeStatisticsDetails); // http body (model) parameter
            }
            else
            {
