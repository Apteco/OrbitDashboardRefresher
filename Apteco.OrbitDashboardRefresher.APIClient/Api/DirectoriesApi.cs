...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface IDirectoriesApi : IApiAccessor
    {
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out.  Leave unspecified to use the default value given in the file service&#39;s configuration (optional)</param>
        /// <param name="filter">Filter the list of items using a simple expression language.  The available list of fields are Name, Type, HasParameters. (optional)</param>
        /// <param name="orderBy">Order the items by a given field (in ascending order unless the field is preceeded by a \&quot;-\&quot; character).  The available list of fields are Name, Type, HasParameters. (optional)</param>
    ...
    public partial class DirectoriesApi : IDirectoriesApi
    {
        ...
        /// <returns></returns>
        public DirectoriesApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
