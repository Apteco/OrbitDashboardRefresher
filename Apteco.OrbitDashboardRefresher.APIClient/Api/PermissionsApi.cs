...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface IPermissionsApi : IApiAccessor
    {
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        AuthorisedPermissionWithLookups PermissionsCreatePermissionForGroup (string dataViewName, string systemName, int? groupId, Permission permission = null);
        ...
        ApiResponse<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForGroupWithHttpInfo (string dataViewName, string systemName, int? groupId, Permission permission = null);
        /// <summary>
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        AuthorisedPermissionWithLookups PermissionsCreatePermissionForSystem (string dataViewName, string systemName, Permission permission = null);
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        ApiResponse<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForSystemWithHttpInfo (string dataViewName, string systemName, Permission permission = null);
        /// <summary>
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        AuthorisedPermissionWithLookups PermissionsCreatePermissionForUser (string dataViewName, string systemName, int? userId, Permission permission = null);
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        ApiResponse<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForUserWithHttpInfo (string dataViewName, string systemName, int? userId, Permission permission = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new tag from the given details
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        /// <param name="tag">The value of the tag to create (optional)</param>
        /// <returns>Tag</returns>
        Tag PermissionsCreateTag (string dataViewName, string systemName, CreateTag tag = null);
        ...
        ApiResponse<Tag> PermissionsCreateTagWithHttpInfo (string dataViewName, string systemName, CreateTag tag = null);
        /// <summary>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes permissions for a given group, for a given resource
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes permissions for a system, for a given resource
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes permissions for a given user, for a given resource
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes the specified tag
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns details of all permission affecting a resource for a group
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns details of all permission affecting a resource for a system
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns details of all permission affecting a resource for a user
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns a summary of permissions for a particular group
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns a summary of permissions for a system
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns a summary of permissions for a particular user
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns the tag for a particular system
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        AuthorisedPermissionWithLookups PermissionsModifyPermission (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null);
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        ApiResponse<AuthorisedPermissionWithLookups> PermissionsModifyPermissionWithHttpInfo (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a given group, for a given resource
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>bool?</returns>
        bool? PermissionsSetPermissionsForGroup (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        ApiResponse<bool?> PermissionsSetPermissionsForGroupWithHttpInfo (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a system, for a given resource
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>bool?</returns>
        bool? PermissionsSetPermissionsForSystem (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        ApiResponse<bool?> PermissionsSetPermissionsForSystemWithHttpInfo (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a given user, for a given resource
        /// </summary>
        /// <remarks>
        /// EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </remarks>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>bool?</returns>
        bool? PermissionsSetPermissionsForUser (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        ApiResponse<bool?> PermissionsSetPermissionsForUserWithHttpInfo (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForGroupAsync (string dataViewName, string systemName, int? groupId, Permission permission = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsCreatePermissionForGroupAsyncWithHttpInfo (string dataViewName, string systemName, int? groupId, Permission permission = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new permission from the given details, using the default permission set for the system.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForSystemAsync (string dataViewName, string systemName, Permission permission = null);
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsCreatePermissionForSystemAsyncWithHttpInfo (string dataViewName, string systemName, Permission permission = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new permission from the given details, using the default permission set for the user.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForUserAsync (string dataViewName, string systemName, int? userId, Permission permission = null);
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsCreatePermissionForUserAsyncWithHttpInfo (string dataViewName, string systemName, int? userId, Permission permission = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new tag from the given details
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Tag> PermissionsCreateTagAsync (string dataViewName, string systemName, CreateTag tag = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Tag>> PermissionsCreateTagAsyncWithHttpInfo (string dataViewName, string systemName, CreateTag tag = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes the specified permission
        /// </summary>
        /// <remarks>
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsModifyPermissionAsync (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null);
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsModifyPermissionAsyncWithHttpInfo (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a given group, for a given resource
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of bool?</returns>
        System.Threading.Tasks.Task<bool?> PermissionsSetPermissionsForGroupAsync (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        System.Threading.Tasks.Task<ApiResponse<bool?>> PermissionsSetPermissionsForGroupAsyncWithHttpInfo (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a system, for a given resource
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of bool?</returns>
        System.Threading.Tasks.Task<bool?> PermissionsSetPermissionsForSystemAsync (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        System.Threading.Tasks.Task<ApiResponse<bool?>> PermissionsSetPermissionsForSystemAsyncWithHttpInfo (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a given user, for a given resource
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of bool?</returns>
        System.Threading.Tasks.Task<bool?> PermissionsSetPermissionsForUserAsync (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        System.Threading.Tasks.Task<ApiResponse<bool?>> PermissionsSetPermissionsForUserAsyncWithHttpInfo (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null);
    ...
    public partial class PermissionsApi : IPermissionsApi
    {
        ...
        /// <returns></returns>
        public PermissionsApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new permission from the given details, using the default permission set for the group. EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        public AuthorisedPermissionWithLookups PermissionsCreatePermissionForGroup (string dataViewName, string systemName, int? groupId, Permission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = PermissionsCreatePermissionForGroupWithHttpInfo(dataViewName, systemName, groupId, permission);
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        public ApiResponse< AuthorisedPermissionWithLookups > PermissionsCreatePermissionForGroupWithHttpInfo (string dataViewName, string systemName, int? groupId, Permission permission = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(permission); // http body (model) parameter
            }
            else
            {
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        public async System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForGroupAsync (string dataViewName, string systemName, int? groupId, Permission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = await PermissionsCreatePermissionForGroupAsyncWithHttpInfo(dataViewName, systemName, groupId, permission);
             return localVarResponse.Data;
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsCreatePermissionForGroupAsyncWithHttpInfo (string dataViewName, string systemName, int? groupId, Permission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsCreatePermissionForGroup");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new permission from the given details, using the default permission set for the system. EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        public AuthorisedPermissionWithLookups PermissionsCreatePermissionForSystem (string dataViewName, string systemName, Permission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = PermissionsCreatePermissionForSystemWithHttpInfo(dataViewName, systemName, permission);
             return localVarResponse.Data;
        }
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        public ApiResponse< AuthorisedPermissionWithLookups > PermissionsCreatePermissionForSystemWithHttpInfo (string dataViewName, string systemName, Permission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        public async System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForSystemAsync (string dataViewName, string systemName, Permission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = await PermissionsCreatePermissionForSystemAsyncWithHttpInfo(dataViewName, systemName, permission);
             return localVarResponse.Data;
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsCreatePermissionForSystemAsyncWithHttpInfo (string dataViewName, string systemName, Permission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsCreatePermissionForSystem");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new permission from the given details, using the default permission set for the user. EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        public AuthorisedPermissionWithLookups PermissionsCreatePermissionForUser (string dataViewName, string systemName, int? userId, Permission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = PermissionsCreatePermissionForUserWithHttpInfo(dataViewName, systemName, userId, permission);
             return localVarResponse.Data;
        }
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        public ApiResponse< AuthorisedPermissionWithLookups > PermissionsCreatePermissionForUserWithHttpInfo (string dataViewName, string systemName, int? userId, Permission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        public async System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsCreatePermissionForUserAsync (string dataViewName, string systemName, int? userId, Permission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = await PermissionsCreatePermissionForUserAsyncWithHttpInfo(dataViewName, systemName, userId, permission);
             return localVarResponse.Data;
        ...
        /// <param name="permission">The details of the permission to create (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsCreatePermissionForUserAsyncWithHttpInfo (string dataViewName, string systemName, int? userId, Permission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsCreatePermissionForUser");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Creates a new tag from the given details EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        /// <param name="tag">The value of the tag to create (optional)</param>
        /// <returns>Tag</returns>
        public Tag PermissionsCreateTag (string dataViewName, string systemName, CreateTag tag = null)
        {
             ApiResponse<Tag> localVarResponse = PermissionsCreateTagWithHttpInfo(dataViewName, systemName, tag);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tag">The value of the tag to create (optional)</param>
        /// <returns>ApiResponse of Tag</returns>
        public ApiResponse< Tag > PermissionsCreateTagWithHttpInfo (string dataViewName, string systemName, CreateTag tag = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="tag">The value of the tag to create (optional)</param>
        /// <returns>Task of Tag</returns>
        public async System.Threading.Tasks.Task<Tag> PermissionsCreateTagAsync (string dataViewName, string systemName, CreateTag tag = null)
        {
             ApiResponse<Tag> localVarResponse = await PermissionsCreateTagAsyncWithHttpInfo(dataViewName, systemName, tag);
             return localVarResponse.Data;
        ...
        /// <param name="tag">The value of the tag to create (optional)</param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Tag>> PermissionsCreateTagAsyncWithHttpInfo (string dataViewName, string systemName, CreateTag tag = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsCreateTag");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes the specified permission EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes permissions for a given group, for a given resource EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes permissions for a system, for a given resource EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes permissions for a given user, for a given resource EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Deletes the specified tag EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns details of all permission affecting a resource for a group EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns details of all permission affecting a resource for a system EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns details of all permission affecting a resource for a user EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns a summary of permissions for a particular group EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns a summary of permissions for a system EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns a summary of permissions for a particular user EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns the permissions for a particular group EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns the permissions for a particular permission set EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns the permissions for a particular system EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns the permissions for a particular user EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Returns the tag for a particular system EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Returns whether the current user is authorised to access a particular resource for a particular permission EXPERIMENTAL
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Modify the specified permission EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        public AuthorisedPermissionWithLookups PermissionsModifyPermission (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = PermissionsModifyPermissionWithHttpInfo(dataViewName, systemName, permissionId, permission);
             return localVarResponse.Data;
        }
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        public ApiResponse< AuthorisedPermissionWithLookups > PermissionsModifyPermissionWithHttpInfo (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        public async System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> PermissionsModifyPermissionAsync (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = await PermissionsModifyPermissionAsyncWithHttpInfo(dataViewName, systemName, permissionId, permission);
             return localVarResponse.Data;
        ...
        /// <param name="permission">The permission to modify (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> PermissionsModifyPermissionAsyncWithHttpInfo (string dataViewName, string systemName, int? permissionId, AuthorisedPermission permission = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsModifyPermission");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a given group, for a given resource EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>bool?</returns>
        public bool? PermissionsSetPermissionsForGroup (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
             ApiResponse<bool?> localVarResponse = PermissionsSetPermissionsForGroupWithHttpInfo(dataViewName, systemName, groupId, resourceType, permissionType, resource, pieces);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > PermissionsSetPermissionsForGroupWithHttpInfo (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (permissionType != null) localVarPathParams.Add("permissionType", this.Configuration.ApiClient.ParameterToString(permissionType)); // path parameter
            if (resource != null) localVarPathParams.Add("resource", this.Configuration.ApiClient.ParameterToString(resource)); // path parameter
            if (pieces != null && pieces.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(pieces); // http body (model) parameter
            }
            else
            {
                localVarPostBody = pieces; // byte array
            }
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> PermissionsSetPermissionsForGroupAsync (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
             ApiResponse<bool?> localVarResponse = await PermissionsSetPermissionsForGroupAsyncWithHttpInfo(dataViewName, systemName, groupId, resourceType, permissionType, resource, pieces);
             return localVarResponse.Data;
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> PermissionsSetPermissionsForGroupAsyncWithHttpInfo (string dataViewName, string systemName, int? groupId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsSetPermissionsForGroup");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a system, for a given resource EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>bool?</returns>
        public bool? PermissionsSetPermissionsForSystem (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
             ApiResponse<bool?> localVarResponse = PermissionsSetPermissionsForSystemWithHttpInfo(dataViewName, systemName, resourceType, permissionType, resource, pieces);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > PermissionsSetPermissionsForSystemWithHttpInfo (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> PermissionsSetPermissionsForSystemAsync (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
             ApiResponse<bool?> localVarResponse = await PermissionsSetPermissionsForSystemAsyncWithHttpInfo(dataViewName, systemName, resourceType, permissionType, resource, pieces);
             return localVarResponse.Data;
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> PermissionsSetPermissionsForSystemAsyncWithHttpInfo (string dataViewName, string systemName, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsSetPermissionsForSystem");
        ...
        /// <summary>
        /// EXPERIMENTAL: Requires OrbitAdmin: Sets permissions for a given user, for a given resource EXPERIMENTAL  This endpoint is only available for users with the OrbitAdmin role
        /// </summary>
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>bool?</returns>
        public bool? PermissionsSetPermissionsForUser (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
             ApiResponse<bool?> localVarResponse = PermissionsSetPermissionsForUserWithHttpInfo(dataViewName, systemName, userId, resourceType, permissionType, resource, pieces);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > PermissionsSetPermissionsForUserWithHttpInfo (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> PermissionsSetPermissionsForUserAsync (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
             ApiResponse<bool?> localVarResponse = await PermissionsSetPermissionsForUserAsyncWithHttpInfo(dataViewName, systemName, userId, resourceType, permissionType, resource, pieces);
             return localVarResponse.Data;
        ...
        /// <param name="pieces">The permission values to set (optional)</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> PermissionsSetPermissionsForUserAsyncWithHttpInfo (string dataViewName, string systemName, int? userId, string resourceType, string permissionType, string resource, List<PermissionPiece> pieces = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling PermissionsApi->PermissionsSetPermissionsForUser");
