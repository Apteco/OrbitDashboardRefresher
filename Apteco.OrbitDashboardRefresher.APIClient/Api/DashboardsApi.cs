...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface IDashboardsApi : IApiAccessor
    {
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>List&lt;DashboardItemDataJobDetail&gt;</returns>
        List<DashboardItemDataJobDetail> DashboardsBatchGetDashboardJobResults (string dataViewName, int? dashboardId, List<int?> jobIds = null);
        ...
        ApiResponse<List<DashboardItemDataJobDetail>> DashboardsBatchGetDashboardJobResultsWithHttpInfo (string dataViewName, int? dashboardId, List<int?> jobIds = null);
        /// <summary>
        ...
        /// <param name="requestData">Used to filter the data on the dashboard item and define the drill down level (optional)</param>
        ...
        List<CalculateDashboardItemJobCreatedResult> DashboardsCalculateDashboardData (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        ...
        ApiResponse<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Aysyncrounously request data needed to render an array of dashboard items
        /// </summary>
        /// <remarks>
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        List<CalculateDashboardItemJobCreatedResult> DashboardsCalculateDashboardDataV2 (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        ApiResponse<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataV2WithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Aysyncrounously request data needed to render an array of dashboard items
        /// </summary>
        /// <remarks>
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        List<CalculateDashboardItemJobCreatedResult> DashboardsCalculateDashboardDataWithFilters (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null);
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        ApiResponse<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataWithFiltersWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        ...
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="dashboardId">The id of the dashboard to calculate the result for</param>
        /// <param name="requestData">Used to pass additional filter query and the name for the new audience (optional)</param>
        /// <returns>ConvertDashboardToAudienceResult</returns>
        ConvertDashboardToAudienceResult DashboardsConvertToAudience (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null);
        ...
        ApiResponse<ConvertDashboardToAudienceResult> DashboardsConvertToAudienceWithHttpInfo (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null);
        /// <summary>
        /// Converts a dashboard (including any global filters applied) to an Audience
        /// </summary>
        /// <remarks>
        ...
        /// <returns>ConvertDashboardToAudienceResult</returns>
        ConvertDashboardToAudienceResult DashboardsConvertToAudienceV2 (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null);
        ...
        /// <param name="dashboardDetail">The details used to create the new dashboard (optional)</param>
        /// <returns>DashboardDetail</returns>
        DashboardDetail DashboardsCopyDashboard (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null);
        ...
        ApiResponse<DashboardDetail> DashboardsCopyDashboardWithHttpInfo (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null);
        /// <summary>
        ...
        /// <exception cref="Apteco.OrbitDashboardRefresher.APIClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>DashboardDetail</returns>
        DashboardDetail DashboardsCreateDashboard (string dataViewName, CreateDashboardDetail dashboardDetail = null);
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>ApiResponse of DashboardDetail</returns>
        ApiResponse<DashboardDetail> DashboardsCreateDashboardWithHttpInfo (string dataViewName, CreateDashboardDetail dashboardDetail = null);
        /// <summary>
        ...
        /// <param name="createDashboardHitDetails">Details to register the hit with (optional)</param>
        /// <returns>DashboardHitDetail</returns>
        DashboardHitDetail DashboardsCreateDashboardHitForDashboard (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null);
        ...
        ApiResponse<DashboardHitDetail> DashboardsCreateDashboardHitForDashboardWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null);
        /// <summary>
        ...
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns></returns>
        void DashboardsCreateDashboardItemPreviewDataJobs (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null);
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DashboardsCreateDashboardItemPreviewDataJobsWithHttpInfo (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null);
        /// <summary>
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>DashboardDetail</returns>
        DashboardDetail DashboardsCreateDashboardUpdate (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null);
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>ApiResponse of DashboardDetail</returns>
        ApiResponse<DashboardDetail> DashboardsCreateDashboardUpdateWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null);
        /// <summary>
        ...
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="dashboardId">The id of the dashboard to calculate the result for</param>
        /// <param name="requestData">Used to filter the data on the dashboard (optional)</param>
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>DashboardExportDataResult</returns>
        DashboardExportDataResult DashboardsGetDashboardExportSync (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null);
        ...
        ApiResponse<DashboardExportDataResult> DashboardsGetDashboardExportSyncWithHttpInfo (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        ...
        DashboardItemDataResultDetail DashboardsGetDashboardItemDataSync (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null);
        ...
        ApiResponse<DashboardItemDataResultDetail> DashboardsGetDashboardItemDataSyncWithHttpInfo (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>List&lt;DashboardItemDataJobDetail&gt;</returns>
        List<DashboardItemDataJobDetail> DashboardsGetDashboardItemPreviewDataJobs (string dataViewName, string systemName, List<int?> jobIds = null);
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>ApiResponse of List&lt;DashboardItemDataJobDetail&gt;</returns>
        ApiResponse<List<DashboardItemDataJobDetail>> DashboardsGetDashboardItemPreviewDataJobsWithHttpInfo (string dataViewName, string systemName, List<int?> jobIds = null);
        /// <summary>
        /// Return data needed to render visualisation for dashboard item
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<DashboardItemDataJobDetail>> DashboardsBatchGetDashboardJobResultsAsync (string dataViewName, int? dashboardId, List<int?> jobIds = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<DashboardItemDataJobDetail>>> DashboardsBatchGetDashboardJobResultsAsyncWithHttpInfo (string dataViewName, int? dashboardId, List<int?> jobIds = null);
        /// <summary>
        /// Aysyncrounously request data needed to render an array of dashboard items
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataAsync (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<CalculateDashboardItemJobCreatedResult>>> DashboardsCalculateDashboardDataAsyncWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Aysyncrounously request data needed to render an array of dashboard items
        /// </summary>
        /// <remarks>
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        System.Threading.Tasks.Task<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataV2Async (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;CalculateDashboardItemJobCreatedResult&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<CalculateDashboardItemJobCreatedResult>>> DashboardsCalculateDashboardDataV2AsyncWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Aysyncrounously request data needed to render an array of dashboard items
        /// </summary>
        /// <remarks>
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        System.Threading.Tasks.Task<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataWithFiltersAsync (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null);
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;CalculateDashboardItemJobCreatedResult&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<CalculateDashboardItemJobCreatedResult>>> DashboardsCalculateDashboardDataWithFiltersAsyncWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Cancel a running calculate dashboard data job
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ConvertDashboardToAudienceResult> DashboardsConvertToAudienceAsync (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ConvertDashboardToAudienceResult>> DashboardsConvertToAudienceAsyncWithHttpInfo (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null);
        /// <summary>
        /// Converts a dashboard (including any global filters applied) to an Audience
        /// </summary>
        /// <remarks>
        ...
        /// <param name="requestData">Used to pass the Dashboard query and the name for the new audience (optional)</param>
        /// <returns>Task of ConvertDashboardToAudienceResult</returns>
        System.Threading.Tasks.Task<ConvertDashboardToAudienceResult> DashboardsConvertToAudienceV2Async (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null);
        ...
        System.Threading.Tasks.Task<DashboardDetail> DashboardsCopyDashboardAsync (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DashboardDetail>> DashboardsCopyDashboardAsyncWithHttpInfo (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null);
        /// <summary>
        /// Creates a new dashboard from the given details for the logged in user.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>Task of DashboardDetail</returns>
        System.Threading.Tasks.Task<DashboardDetail> DashboardsCreateDashboardAsync (string dataViewName, CreateDashboardDetail dashboardDetail = null);
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>Task of ApiResponse (DashboardDetail)</returns>
        System.Threading.Tasks.Task<ApiResponse<DashboardDetail>> DashboardsCreateDashboardAsyncWithHttpInfo (string dataViewName, CreateDashboardDetail dashboardDetail = null);
        /// <summary>
        /// Register a hit (view) for the given dashboard
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DashboardHitDetail> DashboardsCreateDashboardHitForDashboardAsync (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DashboardHitDetail>> DashboardsCreateDashboardHitForDashboardAsyncWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null);
        /// <summary>
        /// Submit an array of jobs to calculate the data needed to render visualisation previews
        /// </summary>
        /// <remarks>
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DashboardsCreateDashboardItemPreviewDataJobsAsync (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null);
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DashboardsCreateDashboardItemPreviewDataJobsAsyncWithHttpInfo (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null);
        /// <summary>
        /// Updates the details of a particular dashboard.  If you don&#39;t have an id for the  dashboard then POST to the /Dashboards URL to create a new dashboard.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>Task of DashboardDetail</returns>
        System.Threading.Tasks.Task<DashboardDetail> DashboardsCreateDashboardUpdateAsync (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null);
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>Task of ApiResponse (DashboardDetail)</returns>
        System.Threading.Tasks.Task<ApiResponse<DashboardDetail>> DashboardsCreateDashboardUpdateAsyncWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null);
        /// <summary>
        /// Deletes the specified dashboard
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DashboardExportDataResult> DashboardsGetDashboardExportSyncAsync (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DashboardExportDataResult>> DashboardsGetDashboardExportSyncAsyncWithHttpInfo (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Returns details for a given dashboard hit for this dashboard
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DashboardItemDataResultDetail> DashboardsGetDashboardItemDataSyncAsync (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DashboardItemDataResultDetail>> DashboardsGetDashboardItemDataSyncAsyncWithHttpInfo (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null);
        /// <summary>
        /// Return data needed to render visualisation for dashboard item when previewing
        /// </summary>
        /// <remarks>
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>Task of List&lt;DashboardItemDataJobDetail&gt;</returns>
        System.Threading.Tasks.Task<List<DashboardItemDataJobDetail>> DashboardsGetDashboardItemPreviewDataJobsAsync (string dataViewName, string systemName, List<int?> jobIds = null);
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;DashboardItemDataJobDetail&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<DashboardItemDataJobDetail>>> DashboardsGetDashboardItemPreviewDataJobsAsyncWithHttpInfo (string dataViewName, string systemName, List<int?> jobIds = null);
        /// <summary>
        /// Return data needed to render visualisation for dashboard item
        /// </summary>
        /// <remarks>
    ...
    public partial class DashboardsApi : IDashboardsApi
    {
        ...
        /// <returns></returns>
        public DashboardsApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>List&lt;DashboardItemDataJobDetail&gt;</returns>
        public List<DashboardItemDataJobDetail> DashboardsBatchGetDashboardJobResults (string dataViewName, int? dashboardId, List<int?> jobIds = null)
        {
             ApiResponse<List<DashboardItemDataJobDetail>> localVarResponse = DashboardsBatchGetDashboardJobResultsWithHttpInfo(dataViewName, dashboardId, jobIds);
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>ApiResponse of List&lt;DashboardItemDataJobDetail&gt;</returns>
        public ApiResponse< List<DashboardItemDataJobDetail> > DashboardsBatchGetDashboardJobResultsWithHttpInfo (string dataViewName, int? dashboardId, List<int?> jobIds = null)
        {
            ...
            if (jobIds != null && jobIds.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(jobIds); // http body (model) parameter
            }
            else
            {
                localVarPostBody = jobIds; // byte array
            }
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>Task of List&lt;DashboardItemDataJobDetail&gt;</returns>
        public async System.Threading.Tasks.Task<List<DashboardItemDataJobDetail>> DashboardsBatchGetDashboardJobResultsAsync (string dataViewName, int? dashboardId, List<int?> jobIds = null)
        {
             ApiResponse<List<DashboardItemDataJobDetail>> localVarResponse = await DashboardsBatchGetDashboardJobResultsAsyncWithHttpInfo(dataViewName, dashboardId, jobIds);
             return localVarResponse.Data;
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;DashboardItemDataJobDetail&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DashboardItemDataJobDetail>>> DashboardsBatchGetDashboardJobResultsAsyncWithHttpInfo (string dataViewName, int? dashboardId, List<int?> jobIds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsBatchGetDashboardJobResults");
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public List<CalculateDashboardItemJobCreatedResult> DashboardsCalculateDashboardData (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<List<CalculateDashboardItemJobCreatedResult>> localVarResponse = DashboardsCalculateDashboardDataWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public ApiResponse< List<CalculateDashboardItemJobCreatedResult> > DashboardsCalculateDashboardDataWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public async System.Threading.Tasks.Task<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataAsync (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<List<CalculateDashboardItemJobCreatedResult>> localVarResponse = await DashboardsCalculateDashboardDataAsyncWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;CalculateDashboardItemJobCreatedResult&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<CalculateDashboardItemJobCreatedResult>>> DashboardsCalculateDashboardDataAsyncWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCalculateDashboardData");
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public List<CalculateDashboardItemJobCreatedResult> DashboardsCalculateDashboardDataV2 (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<List<CalculateDashboardItemJobCreatedResult>> localVarResponse = DashboardsCalculateDashboardDataV2WithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public ApiResponse< List<CalculateDashboardItemJobCreatedResult> > DashboardsCalculateDashboardDataV2WithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public async System.Threading.Tasks.Task<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataV2Async (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<List<CalculateDashboardItemJobCreatedResult>> localVarResponse = await DashboardsCalculateDashboardDataV2AsyncWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;CalculateDashboardItemJobCreatedResult&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<CalculateDashboardItemJobCreatedResult>>> DashboardsCalculateDashboardDataV2AsyncWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCalculateDashboardDataV2");
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public List<CalculateDashboardItemJobCreatedResult> DashboardsCalculateDashboardDataWithFilters (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<List<CalculateDashboardItemJobCreatedResult>> localVarResponse = DashboardsCalculateDashboardDataWithFiltersWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public ApiResponse< List<CalculateDashboardItemJobCreatedResult> > DashboardsCalculateDashboardDataWithFiltersWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of List&lt;CalculateDashboardItemJobCreatedResult&gt;</returns>
        public async System.Threading.Tasks.Task<List<CalculateDashboardItemJobCreatedResult>> DashboardsCalculateDashboardDataWithFiltersAsync (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<List<CalculateDashboardItemJobCreatedResult>> localVarResponse = await DashboardsCalculateDashboardDataWithFiltersAsyncWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;CalculateDashboardItemJobCreatedResult&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<CalculateDashboardItemJobCreatedResult>>> DashboardsCalculateDashboardDataWithFiltersAsyncWithHttpInfo (string dataViewName, int? dashboardId, CalculateDashboardDataWithFilters requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCalculateDashboardDataWithFilters");
        ...
        /// <param name="requestData">Used to pass additional filter query and the name for the new audience (optional)</param>
        /// <returns>ConvertDashboardToAudienceResult</returns>
        public ConvertDashboardToAudienceResult DashboardsConvertToAudience (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
             ApiResponse<ConvertDashboardToAudienceResult> localVarResponse = DashboardsConvertToAudienceWithHttpInfo(dataViewName, dashboardId, requestData);
             return localVarResponse.Data;
        }
        ...
        /// <param name="requestData">Used to pass additional filter query and the name for the new audience (optional)</param>
        /// <returns>ApiResponse of ConvertDashboardToAudienceResult</returns>
        public ApiResponse< ConvertDashboardToAudienceResult > DashboardsConvertToAudienceWithHttpInfo (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="requestData">Used to pass additional filter query and the name for the new audience (optional)</param>
        /// <returns>Task of ConvertDashboardToAudienceResult</returns>
        public async System.Threading.Tasks.Task<ConvertDashboardToAudienceResult> DashboardsConvertToAudienceAsync (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
             ApiResponse<ConvertDashboardToAudienceResult> localVarResponse = await DashboardsConvertToAudienceAsyncWithHttpInfo(dataViewName, dashboardId, requestData);
             return localVarResponse.Data;
        ...
        /// <param name="requestData">Used to pass additional filter query and the name for the new audience (optional)</param>
        /// <returns>Task of ApiResponse (ConvertDashboardToAudienceResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConvertDashboardToAudienceResult>> DashboardsConvertToAudienceAsyncWithHttpInfo (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsConvertToAudience");
        ...
        /// <param name="requestData">Used to pass the Dashboard query and the name for the new audience (optional)</param>
        /// <returns>ConvertDashboardToAudienceResult</returns>
        public ConvertDashboardToAudienceResult DashboardsConvertToAudienceV2 (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
             ApiResponse<ConvertDashboardToAudienceResult> localVarResponse = DashboardsConvertToAudienceV2WithHttpInfo(dataViewName, dashboardId, requestData);
             return localVarResponse.Data;
        }
        ...
        /// <param name="requestData">Used to pass the Dashboard query and the name for the new audience (optional)</param>
        /// <returns>ApiResponse of ConvertDashboardToAudienceResult</returns>
        public ApiResponse< ConvertDashboardToAudienceResult > DashboardsConvertToAudienceV2WithHttpInfo (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="requestData">Used to pass the Dashboard query and the name for the new audience (optional)</param>
        /// <returns>Task of ConvertDashboardToAudienceResult</returns>
        public async System.Threading.Tasks.Task<ConvertDashboardToAudienceResult> DashboardsConvertToAudienceV2Async (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
             ApiResponse<ConvertDashboardToAudienceResult> localVarResponse = await DashboardsConvertToAudienceV2AsyncWithHttpInfo(dataViewName, dashboardId, requestData);
             return localVarResponse.Data;
        ...
        /// <param name="requestData">Used to pass the Dashboard query and the name for the new audience (optional)</param>
        /// <returns>Task of ApiResponse (ConvertDashboardToAudienceResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConvertDashboardToAudienceResult>> DashboardsConvertToAudienceV2AsyncWithHttpInfo (string dataViewName, int? dashboardId, ConvertDashboardToAudience requestData = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsConvertToAudienceV2");
        ...
        /// <param name="dashboardDetail">The details used to create the new dashboard (optional)</param>
        /// <returns>DashboardDetail</returns>
        public DashboardDetail DashboardsCopyDashboard (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null)
        {
             ApiResponse<DashboardDetail> localVarResponse = DashboardsCopyDashboardWithHttpInfo(dataViewName, dashboardId, dashboardDetail);
             return localVarResponse.Data;
        }
        ...
        /// <param name="dashboardDetail">The details used to create the new dashboard (optional)</param>
        /// <returns>ApiResponse of DashboardDetail</returns>
        public ApiResponse< DashboardDetail > DashboardsCopyDashboardWithHttpInfo (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (dataViewName != null) localVarPathParams.Add("dataViewName", this.Configuration.ApiClient.ParameterToString(dataViewName)); // path parameter
            if (dashboardId != null) localVarPathParams.Add("dashboardId", this.Configuration.ApiClient.ParameterToString(dashboardId)); // path parameter
            if (dashboardDetail != null && dashboardDetail.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(dashboardDetail); // http body (model) parameter
            }
            else
            {
                localVarPostBody = dashboardDetail; // byte array
            }
        ...
        /// <param name="dashboardDetail">The details used to create the new dashboard (optional)</param>
        /// <returns>Task of DashboardDetail</returns>
        public async System.Threading.Tasks.Task<DashboardDetail> DashboardsCopyDashboardAsync (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null)
        {
             ApiResponse<DashboardDetail> localVarResponse = await DashboardsCopyDashboardAsyncWithHttpInfo(dataViewName, dashboardId, dashboardDetail);
             return localVarResponse.Data;
        ...
        /// <param name="dashboardDetail">The details used to create the new dashboard (optional)</param>
        /// <returns>Task of ApiResponse (DashboardDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DashboardDetail>> DashboardsCopyDashboardAsyncWithHttpInfo (string dataViewName, int? dashboardId, CopyDashboardDetail dashboardDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCopyDashboard");
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>DashboardDetail</returns>
        public DashboardDetail DashboardsCreateDashboard (string dataViewName, CreateDashboardDetail dashboardDetail = null)
        {
             ApiResponse<DashboardDetail> localVarResponse = DashboardsCreateDashboardWithHttpInfo(dataViewName, dashboardDetail);
             return localVarResponse.Data;
        }
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>ApiResponse of DashboardDetail</returns>
        public ApiResponse< DashboardDetail > DashboardsCreateDashboardWithHttpInfo (string dataViewName, CreateDashboardDetail dashboardDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>Task of DashboardDetail</returns>
        public async System.Threading.Tasks.Task<DashboardDetail> DashboardsCreateDashboardAsync (string dataViewName, CreateDashboardDetail dashboardDetail = null)
        {
             ApiResponse<DashboardDetail> localVarResponse = await DashboardsCreateDashboardAsyncWithHttpInfo(dataViewName, dashboardDetail);
             return localVarResponse.Data;
        ...
        /// <param name="dashboardDetail">The details for the dashboard to create.  If you want              to update a specific dashboard then POST to the /Dashboards/{dashboardId} URL (optional)</param>
        /// <returns>Task of ApiResponse (DashboardDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DashboardDetail>> DashboardsCreateDashboardAsyncWithHttpInfo (string dataViewName, CreateDashboardDetail dashboardDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCreateDashboard");
        ...
        /// <param name="createDashboardHitDetails">Details to register the hit with (optional)</param>
        /// <returns>DashboardHitDetail</returns>
        public DashboardHitDetail DashboardsCreateDashboardHitForDashboard (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null)
        {
             ApiResponse<DashboardHitDetail> localVarResponse = DashboardsCreateDashboardHitForDashboardWithHttpInfo(dataViewName, dashboardId, createDashboardHitDetails);
             return localVarResponse.Data;
        }
        ...
        /// <param name="createDashboardHitDetails">Details to register the hit with (optional)</param>
        /// <returns>ApiResponse of DashboardHitDetail</returns>
        public ApiResponse< DashboardHitDetail > DashboardsCreateDashboardHitForDashboardWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (dataViewName != null) localVarPathParams.Add("dataViewName", this.Configuration.ApiClient.ParameterToString(dataViewName)); // path parameter
            if (dashboardId != null) localVarPathParams.Add("dashboardId", this.Configuration.ApiClient.ParameterToString(dashboardId)); // path parameter
            if (createDashboardHitDetails != null && createDashboardHitDetails.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createDashboardHitDetails); // http body (model) parameter
            }
            else
            {
                localVarPostBody = createDashboardHitDetails; // byte array
            }
        ...
        /// <param name="createDashboardHitDetails">Details to register the hit with (optional)</param>
        /// <returns>Task of DashboardHitDetail</returns>
        public async System.Threading.Tasks.Task<DashboardHitDetail> DashboardsCreateDashboardHitForDashboardAsync (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null)
        {
             ApiResponse<DashboardHitDetail> localVarResponse = await DashboardsCreateDashboardHitForDashboardAsyncWithHttpInfo(dataViewName, dashboardId, createDashboardHitDetails);
             return localVarResponse.Data;
        ...
        /// <param name="createDashboardHitDetails">Details to register the hit with (optional)</param>
        /// <returns>Task of ApiResponse (DashboardHitDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DashboardHitDetail>> DashboardsCreateDashboardHitForDashboardAsyncWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardHitDetails createDashboardHitDetails = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCreateDashboardHitForDashboard");
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns></returns>
        public void DashboardsCreateDashboardItemPreviewDataJobs (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null)
        {
             DashboardsCreateDashboardItemPreviewDataJobsWithHttpInfo(dataViewName, systemName, requestData);
        }
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DashboardsCreateDashboardItemPreviewDataJobsWithHttpInfo (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DashboardsCreateDashboardItemPreviewDataJobsAsync (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null)
        {
             await DashboardsCreateDashboardItemPreviewDataJobsAsyncWithHttpInfo(dataViewName, systemName, requestData);
        ...
        /// <param name="requestData">The data required to process the request (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DashboardsCreateDashboardItemPreviewDataJobsAsyncWithHttpInfo (string dataViewName, string systemName, List<DashboardItemPreviewData> requestData = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCreateDashboardItemPreviewDataJobs");
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>DashboardDetail</returns>
        public DashboardDetail DashboardsCreateDashboardUpdate (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null)
        {
             ApiResponse<DashboardDetail> localVarResponse = DashboardsCreateDashboardUpdateWithHttpInfo(dataViewName, dashboardId, dashboardDetail);
             return localVarResponse.Data;
        }
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>ApiResponse of DashboardDetail</returns>
        public ApiResponse< DashboardDetail > DashboardsCreateDashboardUpdateWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>Task of DashboardDetail</returns>
        public async System.Threading.Tasks.Task<DashboardDetail> DashboardsCreateDashboardUpdateAsync (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null)
        {
             ApiResponse<DashboardDetail> localVarResponse = await DashboardsCreateDashboardUpdateAsyncWithHttpInfo(dataViewName, dashboardId, dashboardDetail);
             return localVarResponse.Data;
        ...
        /// <param name="dashboardDetail">The details for the dashboard to add/update (optional)</param>
        /// <returns>Task of ApiResponse (DashboardDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DashboardDetail>> DashboardsCreateDashboardUpdateAsyncWithHttpInfo (string dataViewName, int? dashboardId, CreateDashboardUpdateDetail dashboardDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsCreateDashboardUpdate");
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>DashboardExportDataResult</returns>
        public DashboardExportDataResult DashboardsGetDashboardExportSync (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<DashboardExportDataResult> localVarResponse = DashboardsGetDashboardExportSyncWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of DashboardExportDataResult</returns>
        public ApiResponse< DashboardExportDataResult > DashboardsGetDashboardExportSyncWithHttpInfo (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of DashboardExportDataResult</returns>
        public async System.Threading.Tasks.Task<DashboardExportDataResult> DashboardsGetDashboardExportSyncAsync (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<DashboardExportDataResult> localVarResponse = await DashboardsGetDashboardExportSyncAsyncWithHttpInfo(dataViewName, dashboardId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (DashboardExportDataResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DashboardExportDataResult>> DashboardsGetDashboardExportSyncAsyncWithHttpInfo (string dataViewName, int? dashboardId, DashboardExportData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsGetDashboardExportSync");
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>DashboardItemDataResultDetail</returns>
        public DashboardItemDataResultDetail DashboardsGetDashboardItemDataSync (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<DashboardItemDataResultDetail> localVarResponse = DashboardsGetDashboardItemDataSyncWithHttpInfo(dataViewName, dashboardId, dashboardItemId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>ApiResponse of DashboardItemDataResultDetail</returns>
        public ApiResponse< DashboardItemDataResultDetail > DashboardsGetDashboardItemDataSyncWithHttpInfo (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of DashboardItemDataResultDetail</returns>
        public async System.Threading.Tasks.Task<DashboardItemDataResultDetail> DashboardsGetDashboardItemDataSyncAsync (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null)
        {
             ApiResponse<DashboardItemDataResultDetail> localVarResponse = await DashboardsGetDashboardItemDataSyncAsyncWithHttpInfo(dataViewName, dashboardId, dashboardItemId, requestData, timeoutInSeconds);
             return localVarResponse.Data;
        ...
        /// <param name="timeoutInSeconds">The number of seconds before the request will time out. Leave unspecified to use the default value given in the dashboards service&#39;s configuration (optional)</param>
        /// <returns>Task of ApiResponse (DashboardItemDataResultDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DashboardItemDataResultDetail>> DashboardsGetDashboardItemDataSyncAsyncWithHttpInfo (string dataViewName, int? dashboardId, string dashboardItemId, DashboardItemData requestData = null, int? timeoutInSeconds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsGetDashboardItemDataSync");
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>List&lt;DashboardItemDataJobDetail&gt;</returns>
        public List<DashboardItemDataJobDetail> DashboardsGetDashboardItemPreviewDataJobs (string dataViewName, string systemName, List<int?> jobIds = null)
        {
             ApiResponse<List<DashboardItemDataJobDetail>> localVarResponse = DashboardsGetDashboardItemPreviewDataJobsWithHttpInfo(dataViewName, systemName, jobIds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>ApiResponse of List&lt;DashboardItemDataJobDetail&gt;</returns>
        public ApiResponse< List<DashboardItemDataJobDetail> > DashboardsGetDashboardItemPreviewDataJobsWithHttpInfo (string dataViewName, string systemName, List<int?> jobIds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>Task of List&lt;DashboardItemDataJobDetail&gt;</returns>
        public async System.Threading.Tasks.Task<List<DashboardItemDataJobDetail>> DashboardsGetDashboardItemPreviewDataJobsAsync (string dataViewName, string systemName, List<int?> jobIds = null)
        {
             ApiResponse<List<DashboardItemDataJobDetail>> localVarResponse = await DashboardsGetDashboardItemPreviewDataJobsAsyncWithHttpInfo(dataViewName, systemName, jobIds);
             return localVarResponse.Data;
        ...
        /// <param name="jobIds">An array of the jobIds to get the results for (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;DashboardItemDataJobDetail&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DashboardItemDataJobDetail>>> DashboardsGetDashboardItemPreviewDataJobsAsyncWithHttpInfo (string dataViewName, string systemName, List<int?> jobIds = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling DashboardsApi->DashboardsGetDashboardItemPreviewDataJobs");
