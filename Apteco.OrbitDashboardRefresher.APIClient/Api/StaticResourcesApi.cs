...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface IStaticResourcesApi : IApiAccessor
    {
        ...
        /// <param name="dataViewName">The name of the DataView to find the resource for</param>
        /// <param name="resourceCategory">The category of the resource to return</param>
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns></returns>
        void StaticResourcesPostStaticResourceFile (string dataViewName, string resourceCategory, System.IO.Stream _file = null);
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> StaticResourcesPostStaticResourceFileWithHttpInfo (string dataViewName, string resourceCategory, System.IO.Stream _file = null);
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task StaticResourcesPostStaticResourceFileAsync (string dataViewName, string resourceCategory, System.IO.Stream _file = null);
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> StaticResourcesPostStaticResourceFileAsyncWithHttpInfo (string dataViewName, string resourceCategory, System.IO.Stream _file = null);
    ...
    public partial class StaticResourcesApi : IStaticResourcesApi
    {
        ...
        /// <returns></returns>
        public StaticResourcesApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns></returns>
        public void StaticResourcesPostStaticResourceFile (string dataViewName, string resourceCategory, System.IO.Stream _file = null)
        {
             StaticResourcesPostStaticResourceFileWithHttpInfo(dataViewName, resourceCategory, _file);
        }
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> StaticResourcesPostStaticResourceFileWithHttpInfo (string dataViewName, string resourceCategory, System.IO.Stream _file = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task StaticResourcesPostStaticResourceFileAsync (string dataViewName, string resourceCategory, System.IO.Stream _file = null)
        {
             await StaticResourcesPostStaticResourceFileAsyncWithHttpInfo(dataViewName, resourceCategory, _file);
        ...
        /// <param name="_file">The file to upload (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> StaticResourcesPostStaticResourceFileAsyncWithHttpInfo (string dataViewName, string resourceCategory, System.IO.Stream _file = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling StaticResourcesApi->StaticResourcesPostStaticResourceFile");
