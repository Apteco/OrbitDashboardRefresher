...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface ILinkedInTokensApi : IApiAccessor
    {
        ...
        /// <param name="validateAndStoreLinkedInTokens">The details of the tokens to validate and store (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        AuthorisedPermissionWithLookups LinkedInTokensValidateAndStoreLinkedInTokens (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null);
        ...
        ApiResponse<AuthorisedPermissionWithLookups> LinkedInTokensValidateAndStoreLinkedInTokensWithHttpInfo (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null);
        ...
        System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> LinkedInTokensValidateAndStoreLinkedInTokensAsync (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> LinkedInTokensValidateAndStoreLinkedInTokensAsyncWithHttpInfo (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null);
    ...
    public partial class LinkedInTokensApi : ILinkedInTokensApi
    {
        ...
        /// <returns></returns>
        public LinkedInTokensApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="validateAndStoreLinkedInTokens">The details of the tokens to validate and store (optional)</param>
        /// <returns>AuthorisedPermissionWithLookups</returns>
        public AuthorisedPermissionWithLookups LinkedInTokensValidateAndStoreLinkedInTokens (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = LinkedInTokensValidateAndStoreLinkedInTokensWithHttpInfo(dataViewName, username, validateAndStoreLinkedInTokens);
             return localVarResponse.Data;
        }
        ...
        /// <param name="validateAndStoreLinkedInTokens">The details of the tokens to validate and store (optional)</param>
        /// <returns>ApiResponse of AuthorisedPermissionWithLookups</returns>
        public ApiResponse< AuthorisedPermissionWithLookups > LinkedInTokensValidateAndStoreLinkedInTokensWithHttpInfo (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (dataViewName != null) localVarPathParams.Add("dataViewName", this.Configuration.ApiClient.ParameterToString(dataViewName)); // path parameter
            if (username != null) localVarPathParams.Add("username", this.Configuration.ApiClient.ParameterToString(username)); // path parameter
            if (validateAndStoreLinkedInTokens != null && validateAndStoreLinkedInTokens.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(validateAndStoreLinkedInTokens); // http body (model) parameter
            }
            else
            {
                localVarPostBody = validateAndStoreLinkedInTokens; // byte array
            }
        ...
        /// <param name="validateAndStoreLinkedInTokens">The details of the tokens to validate and store (optional)</param>
        /// <returns>Task of AuthorisedPermissionWithLookups</returns>
        public async System.Threading.Tasks.Task<AuthorisedPermissionWithLookups> LinkedInTokensValidateAndStoreLinkedInTokensAsync (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null)
        {
             ApiResponse<AuthorisedPermissionWithLookups> localVarResponse = await LinkedInTokensValidateAndStoreLinkedInTokensAsyncWithHttpInfo(dataViewName, username, validateAndStoreLinkedInTokens);
             return localVarResponse.Data;
        ...
        /// <param name="validateAndStoreLinkedInTokens">The details of the tokens to validate and store (optional)</param>
        /// <returns>Task of ApiResponse (AuthorisedPermissionWithLookups)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthorisedPermissionWithLookups>> LinkedInTokensValidateAndStoreLinkedInTokensAsyncWithHttpInfo (string dataViewName, string username, ValidateAndStoreLinkedInTokens validateAndStoreLinkedInTokens = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling LinkedInTokensApi->LinkedInTokensValidateAndStoreLinkedInTokens");
