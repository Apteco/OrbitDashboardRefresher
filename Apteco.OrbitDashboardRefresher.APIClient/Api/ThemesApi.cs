...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface IThemesApi : IApiAccessor
    {
        ...
        /// <param name="themeDetail">The details for the theme to create.  If you want              to update a specific theme then POST to the /Theme/{themeId} URL (optional)</param>
        /// <returns>Theme</returns>
        Theme ThemesCreateTheme (string dataViewName, CreateUpdateTheme themeDetail = null);
        ...
        ApiResponse<Theme> ThemesCreateThemeWithHttpInfo (string dataViewName, CreateUpdateTheme themeDetail = null);
        /// <summary>
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>Theme</returns>
        Theme ThemesUpdateTheme (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null);
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>ApiResponse of Theme</returns>
        ApiResponse<Theme> ThemesUpdateThemeWithHttpInfo (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null);
        ...
        System.Threading.Tasks.Task<Theme> ThemesCreateThemeAsync (string dataViewName, CreateUpdateTheme themeDetail = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Theme>> ThemesCreateThemeAsyncWithHttpInfo (string dataViewName, CreateUpdateTheme themeDetail = null);
        /// <summary>
        /// Requires OrbitAdmin: Deletes the specified theme
        /// </summary>
        /// <remarks>
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>Task of Theme</returns>
        System.Threading.Tasks.Task<Theme> ThemesUpdateThemeAsync (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null);
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>Task of ApiResponse (Theme)</returns>
        System.Threading.Tasks.Task<ApiResponse<Theme>> ThemesUpdateThemeAsyncWithHttpInfo (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null);
    ...
    public partial class ThemesApi : IThemesApi
    {
        ...
        /// <returns></returns>
        public ThemesApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="themeDetail">The details for the theme to create.  If you want              to update a specific theme then POST to the /Theme/{themeId} URL (optional)</param>
        /// <returns>Theme</returns>
        public Theme ThemesCreateTheme (string dataViewName, CreateUpdateTheme themeDetail = null)
        {
             ApiResponse<Theme> localVarResponse = ThemesCreateThemeWithHttpInfo(dataViewName, themeDetail);
        ...
        /// <param name="themeDetail">The details for the theme to create.  If you want              to update a specific theme then POST to the /Theme/{themeId} URL (optional)</param>
        /// <returns>ApiResponse of Theme</returns>
        public ApiResponse< Theme > ThemesCreateThemeWithHttpInfo (string dataViewName, CreateUpdateTheme themeDetail = null)
        {
            ...
            if (themeDetail != null && themeDetail.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(themeDetail); // http body (model) parameter
            }
            else
            {
                localVarPostBody = themeDetail; // byte array
            }
        ...
        /// <param name="themeDetail">The details for the theme to create.  If you want              to update a specific theme then POST to the /Theme/{themeId} URL (optional)</param>
        /// <returns>Task of Theme</returns>
        public async System.Threading.Tasks.Task<Theme> ThemesCreateThemeAsync (string dataViewName, CreateUpdateTheme themeDetail = null)
        {
             ApiResponse<Theme> localVarResponse = await ThemesCreateThemeAsyncWithHttpInfo(dataViewName, themeDetail);
             return localVarResponse.Data;
        ...
        /// <param name="themeDetail">The details for the theme to create.  If you want              to update a specific theme then POST to the /Theme/{themeId} URL (optional)</param>
        /// <returns>Task of ApiResponse (Theme)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Theme>> ThemesCreateThemeAsyncWithHttpInfo (string dataViewName, CreateUpdateTheme themeDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling ThemesApi->ThemesCreateTheme");
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>Theme</returns>
        public Theme ThemesUpdateTheme (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null)
        {
             ApiResponse<Theme> localVarResponse = ThemesUpdateThemeWithHttpInfo(dataViewName, themeId, themeDetail);
             return localVarResponse.Data;
        }
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>ApiResponse of Theme</returns>
        public ApiResponse< Theme > ThemesUpdateThemeWithHttpInfo (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>Task of Theme</returns>
        public async System.Threading.Tasks.Task<Theme> ThemesUpdateThemeAsync (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null)
        {
             ApiResponse<Theme> localVarResponse = await ThemesUpdateThemeAsyncWithHttpInfo(dataViewName, themeId, themeDetail);
             return localVarResponse.Data;
        ...
        /// <param name="themeDetail">The details for the theme to update (optional)</param>
        /// <returns>Task of ApiResponse (Theme)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Theme>> ThemesUpdateThemeAsyncWithHttpInfo (string dataViewName, int? themeId, CreateUpdateTheme themeDetail = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling ThemesApi->ThemesUpdateTheme");
