...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public partial class CollectionsApi : ICollectionsApi
    {
        ...
        /// <returns></returns>
        public CollectionsApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< UpsertCollectionDetail > CollectionsCreateCollectionWithHttpInfo (string dataViewName, UpsertCollectionDetail collectionDetail = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(collectionDetail); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse< CollectionHitDetail > CollectionsCreateCollectionHitForCollectionWithHttpInfo (string dataViewName, int? collectionId, CreateCollectionHitDetails createCollectionHitDetails = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createCollectionHitDetails); // http body (model) parameter
            }
            else
            {
