...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public partial class UserRegistrationRequestsApi : IUserRegistrationRequestsApi
    {
        ...
        /// <returns></returns>
        public UserRegistrationRequestsApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< UserRegistrationRequestDetail > UserRegistrationRequestsCreateRegistrationRequestWithHttpInfo (string dataViewName, CreateUserRegistrationRequest createUserRegistrationRequest = null)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createUserRegistrationRequest); // http body (model) parameter
            }
            else
            {
