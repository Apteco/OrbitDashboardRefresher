...
namespace Apteco.OrbitDashboardRefresher.APIClient.Api
{
    ...
    public interface ILicencesApi : IApiAccessor
    {
        ...
        /// <param name="dataViewName">The name of the DataView to act on</param>
        /// <param name="systemName">The name of the FastStats system to act on</param>
        /// <param name="registerSystemLicenceDetails">The details of the licence to register (optional)</param>
        /// <returns></returns>
        void LicencesRegisterSystemLicence (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null);
        ...
        ApiResponse<Object> LicencesRegisterSystemLicenceWithHttpInfo (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null);
        /// <summary>
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>LicensedUserDetail</returns>
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>ApiResponse of LicensedUserDetail</returns>
        ApiResponse<LicensedUserDetail> LicencesUpsertLicencedUserWithHttpInfo (string dataViewName, string systemName, int? licenceId, int? userId, ApplySystemLicenceToUserDetails applySystemLicenceToUserDetails = null);
        ...
        System.Threading.Tasks.Task LicencesRegisterSystemLicenceAsync (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> LicencesRegisterSystemLicenceAsyncWithHttpInfo (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null);
        /// <summary>
        /// UNDER DEVELOPMENT: Requires OrbitAdmin: Remove the user from the specified licence on the given system
        /// </summary>
        /// <remarks>
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>Task of ApiResponse (LicensedUserDetail)</returns>
        System.Threading.Tasks.Task<ApiResponse<LicensedUserDetail>> LicencesUpsertLicencedUserAsyncWithHttpInfo (string dataViewName, string systemName, int? licenceId, int? userId, ApplySystemLicenceToUserDetails applySystemLicenceToUserDetails = null);
    ...
    public partial class LicencesApi : ILicencesApi
    {
        ...
        /// <returns></returns>
        public LicencesApi(Apteco.OrbitDashboardRefresher.APIClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="registerSystemLicenceDetails">The details of the licence to register (optional)</param>
        /// <returns></returns>
        public void LicencesRegisterSystemLicence (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null)
        {
             LicencesRegisterSystemLicenceWithHttpInfo(dataViewName, systemName, registerSystemLicenceDetails);
        }
        ...
        /// <param name="registerSystemLicenceDetails">The details of the licence to register (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> LicencesRegisterSystemLicenceWithHttpInfo (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (dataViewName != null) localVarPathParams.Add("dataViewName", this.Configuration.ApiClient.ParameterToString(dataViewName)); // path parameter
            if (systemName != null) localVarPathParams.Add("systemName", this.Configuration.ApiClient.ParameterToString(systemName)); // path parameter
            if (registerSystemLicenceDetails != null && registerSystemLicenceDetails.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(registerSystemLicenceDetails); // http body (model) parameter
            }
            else
            {
                localVarPostBody = registerSystemLicenceDetails; // byte array
            }
        ...
        /// <param name="registerSystemLicenceDetails">The details of the licence to register (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task LicencesRegisterSystemLicenceAsync (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null)
        {
             await LicencesRegisterSystemLicenceAsyncWithHttpInfo(dataViewName, systemName, registerSystemLicenceDetails);
        ...
        /// <param name="registerSystemLicenceDetails">The details of the licence to register (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> LicencesRegisterSystemLicenceAsyncWithHttpInfo (string dataViewName, string systemName, RegisterSystemLicenceDetails registerSystemLicenceDetails = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling LicencesApi->LicencesRegisterSystemLicence");
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>LicensedUserDetail</returns>
        public LicensedUserDetail LicencesUpsertLicencedUser (string dataViewName, string systemName, int? licenceId, int? userId, ApplySystemLicenceToUserDetails applySystemLicenceToUserDetails = null)
        {
             ApiResponse<LicensedUserDetail> localVarResponse = LicencesUpsertLicencedUserWithHttpInfo(dataViewName, systemName, licenceId, userId, applySystemLicenceToUserDetails);
             return localVarResponse.Data;
        }
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>ApiResponse of LicensedUserDetail</returns>
        public ApiResponse< LicensedUserDetail > LicencesUpsertLicencedUserWithHttpInfo (string dataViewName, string systemName, int? licenceId, int? userId, ApplySystemLicenceToUserDetails applySystemLicenceToUserDetails = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (licenceId != null) localVarPathParams.Add("licenceId", this.Configuration.ApiClient.ParameterToString(licenceId)); // path parameter
            if (userId != null) localVarPathParams.Add("userId", this.Configuration.ApiClient.ParameterToString(userId)); // path parameter
            if (applySystemLicenceToUserDetails != null && applySystemLicenceToUserDetails.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(applySystemLicenceToUserDetails); // http body (model) parameter
            }
            else
            {
                localVarPostBody = applySystemLicenceToUserDetails; // byte array
            }
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>Task of LicensedUserDetail</returns>
        public async System.Threading.Tasks.Task<LicensedUserDetail> LicencesUpsertLicencedUserAsync (string dataViewName, string systemName, int? licenceId, int? userId, ApplySystemLicenceToUserDetails applySystemLicenceToUserDetails = null)
        {
             ApiResponse<LicensedUserDetail> localVarResponse = await LicencesUpsertLicencedUserAsyncWithHttpInfo(dataViewName, systemName, licenceId, userId, applySystemLicenceToUserDetails);
             return localVarResponse.Data;
        ...
        /// <param name="applySystemLicenceToUserDetails">The details of which bundles of the specified licence to apply to the given user (optional)</param>
        /// <returns>Task of ApiResponse (LicensedUserDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LicensedUserDetail>> LicencesUpsertLicencedUserAsyncWithHttpInfo (string dataViewName, string systemName, int? licenceId, int? userId, ApplySystemLicenceToUserDetails applySystemLicenceToUserDetails = null)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling LicencesApi->LicencesUpsertLicencedUser");
