...
2. Download the latest stable release of the version 2 swagger-codegen (see 
...
3. There is a [json options file](../swagger-codegen-options.json)
in the solution directory that contains some settings to use when generating the
API client code.
